...
A6-Stern is a browser-based **construction site documentation platform**. Users upload photos, 360° panoramas, videos, PDFs, and 3D LiDAR point clouds captured on site; the platform organises them by project / room / date, generates AI-assisted analyses, and lets engineers publish structured PDF field reports.

A6-Stern (the namesake) is a single construction project being monitored on the platform. The platform itself supports multiple projects, multiple users, role-based access control, and side-by-side temporal comparison of any two captures.
...
```
/opt/a6-stern/             ← parent directory (any name is fine)
